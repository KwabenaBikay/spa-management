...
if (!isset($_SESSION['user']) || ($_SESSION['user']['role'] !== 'massage' && $_SESSION['user']['role'] !== 'therapist')) {
    header("Location: ../login.php");
    exit;
}

// Ensure table has status column
...
$result = $conn->query("SELECT * FROM clients WHERE section = 'Massage' ORDER BY created_at DESC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Massage Dashboard | The Breeze Spa</title>
...
<aside class="sidebar">
    ...
    <nav>
        <a href="massage.php" class="menu-item active"><i class="fas fa-home" style="margin-right:12px;"></i> Dashboard</a>
    </nav>
...
<main class="main-content">
    ...
    <div class="flat-card">
        <div class="flat-card-header"><h3>Assigned Clients – Massage Section</h3></div>
            ...
            <table>
                ...
                <tbody id="worker-table-body">
                    ...
                    <tr>
                        ...
                        <td><?= htmlspecialchars($row['massage_type']) ?></td>
