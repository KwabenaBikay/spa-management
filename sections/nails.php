...
if (!isset($_SESSION['user']) || $_SESSION['user']['role'] !== 'nails') {
...
$result = $conn->query("SELECT * FROM clients WHERE section IN ('Nails & Manicure', 'Pedicure & Manicure') ORDER BY created_at DESC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Nails Dashboard | The Breeze Spa</title>
...
<aside class="sidebar">
    ...
    <nav>
        <a href="nails.php" class="menu-item active"><i class="fas fa-home" style="margin-right:12px;"></i> Dashboard</a>
    </nav>
...
<main class="main-content">
    ...
    <div class="flat-card">
        <div class="flat-card-header"><h3>Assigned Clients – Nails, Pedicure & Manicure</h3></div>
