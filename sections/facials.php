...
if (!isset($_SESSION['user']) || $_SESSION['user']['role'] !== 'facials') {
...
$result = $conn->query("SELECT * FROM clients WHERE section = 'Facials' ORDER BY created_at DESC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Facials Dashboard | The Breeze Spa</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', sans-serif; }
        ...
        td { padding: 16px 14px; border-bottom: 1px solid var(--border-color); }
        
        select { padding: 8px; border: 1px solid var(--border-color); border-radius: 2px; cursor: pointer; }
...
<aside class="sidebar">
    ...
    <nav>
        <a href="facials.php" class="menu-item active"><i class="fas fa-home" style="margin-right:12px;"></i> Dashboard</a>
    </nav>
...
<main class="main-content">
    ...
    <div class="flat-card">
        <div class="flat-card-header"><h3>Assigned Clients</h3></div>
        <table>
            <thead>
                <tr>
                    <th>Name</th>
