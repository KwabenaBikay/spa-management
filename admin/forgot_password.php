            ...
            <?php else: ?>
                <form method="post" action="">
                    <div class="input-group">
                        ...
                        <input type="text" name="username" placeholder="e.g., admin_bismark" required autofocus>
                    </div>
                    <button type="submit">Generate Reset Link</button>
                </form>
            <?php endif; ?>
            
            <a class="footer-link" href="login.php"><i class="fas fa-arrow-left"></i> Return to Login</a>
        </div>
    </div>
</body>
</html>